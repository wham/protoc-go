...
# Compile + protoc-gen-go on the kaja.tools demo schemas, in-process and as a
# subprocess; needs a kaja-tools/website checkout and protoc-gen-go on PATH
KAJA_WEBSITE=../website go test ./protoc/ -run='^$' -bench=GenerateGo -benchmem
```
